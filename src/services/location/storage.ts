...
/**
 * New version of 'getLocations()'
 */
//  export async function getLocations(): Promise<LocationObject[]> {
//   const data = await DataStore.query(Location); //AsyncStorage.getItem(locationStorageName);
//   return data ? JSON.parse(data) : [];
// }

/**
* New version of 'setLocations()'
 */
// export async function setLocations(locations: LocationObject[]): Promise<void> {
//   const newLocation = await DataStore.save(
//     new Location({
...
//   )
  ...
  //     timestamp: 
  //   })
//   ) //AsyncStorage.setItem(locationStorageName, JSON.stringify(locations));
// }


/**
 * New version of `addLocation`
 */
